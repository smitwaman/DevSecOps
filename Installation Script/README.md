**DevOps**: This is a set of practices that combines software development (Dev) with IT operations (Ops) to improve the speed and efficiency of software delivery.
